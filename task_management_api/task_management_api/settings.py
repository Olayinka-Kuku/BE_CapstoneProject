...
SECRET_KEY = 'django-insecure-5&z^xz=q!o=_p6g@evhw9hgo1k3vhn7%hj*@+a!%fy4k%il7eh'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication', #Added SessionAuthentication for Browsable API
    ],
